...
public class CoreDataModule {
    ...
    public init(entityName: String, appName: String) {
        entity = entityName
        name = appName.replacingOccurrences(of: " ", with: "_")
    }
    ...
    private lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "ByCyril.OneID" in the application's documents Application Support directory.
    ...
    public func saveData<V>(values: [V], keys: [String]) {
    ...
    public func sortData(byKey: String, ascending: Bool) -> [NSManagedObject] {
